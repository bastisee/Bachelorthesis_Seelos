...
# --- Load CSV ---
file_path = "impact_data/damp_shot_dist/impact_020.csv"
...
def estimate_aoa23_from_delay(tdoa_31, mic1, mic2):
    # Compute vector from mic1 to mic3
    dx = mic2[0] - mic1[0]
    dy = mic2[1] - mic1[1]
    mic_distance = np.hypot(dx, dy)
...
delay_21 = get_delay_range(windowed['Mic2'], windowed['Mic1'], min_lag=-150, max_lag=150)  # Mic2 - Mic1
delay_31 = get_delay_range(windowed['Mic3'], windowed['Mic1'], min_lag=-150, max_lag=150)  # Mic3 - Mic1
